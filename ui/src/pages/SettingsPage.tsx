      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              {[
                { label: 'Swagger UI', url: 'http://localhost:8000/docs', desc: 'Interactive API explorer' },
                { label: 'ReDoc', url: 'http://localhost:8000/redoc', desc: 'Full API reference' },
                { label: 'OpenAPI JSON', url: 'http://localhost:8000/openapi.json', desc: 'Machine-readable schema' },
              ].map(({ label, url, desc }) => (
                <a
                  key={url}
                  href={url}
